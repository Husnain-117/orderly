...
import { Edit, Camera, User, Mail, Building, Phone, MapPin } from "lucide-react";
...
const Profile = () => {
  ...
  return (
    <>
      <SEO title="Wholesale Profile • Orderly" description="Manage your distributor account and settings." />
      <AppLayout>
        <AppSidebar items={wholesaleItems} />
        <main className="w-full max-w-4xl mx-auto px-6 py-4">
          <div className="mb-6">
              ...
              <div className="border-t border-slate-200 pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-slate-50 rounded-lg p-4">
                    ...
                    <p className="text-slate-800 mt-1">Wholesale Distributor</p>
                  </div>
                  <div className="bg-slate-50 rounded-lg p-4">
